...
// OrderReview 限时活动订单评价（仅核销后的订单可评价，一单一评）
// 评分 1-5 对应：非常差、较差、一般、推荐、超赞
type OrderReview struct {
	global.GVA_MODEL
	OrderID uint   `json:"orderId" form:"orderId" gorm:"column:order_id;comment:订单ID;uniqueIndex:idx_la_order_review;"`
...
func (OrderReview) TableName() string {
	return "limited_activity_order_reviews"
}
