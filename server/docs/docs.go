...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/camping/mini/reservation/cancelRule": {
            "get": {
        ...
        "/camping/mini/reservation/create": {
            "post": {
        ...
        "/camping/mini/reservation/review/create": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.CreateReservationReviewRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/model.VenueReservationReview"
                                        },
                                        "msg": {
                                            "type": "string"
                                        }
        ...
        "/camping/mini/reservation/review/delete": {
            "post": {
        ...
        "/camping/mini/reservation/update": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "修改后的预约信息",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.UpdateVenueReservationRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/camping/mini/slot/availableSlots": {
            "get": {
        ...
        "/camping/reservation/cancelReservation": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/camping/reservation/getReservation": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/camping/reservation/getReservationByVerifyCodePublic": {
            "get": {
                "tags": [
                    "CampingReservation"
                ],
        ...
        "/camping/reservation/getReservationList": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/camping/reservation/getReservedSlotIdsPublic": {
            "get": {
                "tags": [
                    "CampingReservation"
                ],
        ...
        "/camping/reservation/verifyReservation": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/camping/reservation/verifyReservationByCode": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/camping/site/getSiteDetailPublic": {
            "get": {
                "tags": [
                    "CampingSite"
                ],
        ...
        "/camping/site/getSiteListPublic": {
            "get": {
                "tags": [
                    "CampingSite"
                ],
        ...
        "/camping/timeSlot/createTimeSlot": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.VenueTimeslot"
                        }
                    }
                ],
                "responses": {
        ...
        "/camping/timeSlot/deleteTimeSlot": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/camping/timeSlot/deleteTimeSlotByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/camping/timeSlot/getAllTimeSlotsPublic": {
            "get": {
                "tags": [
                    "CampingTimeSlot"
                ],
        ...
        "/camping/timeSlot/getTimeSlotList": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/camping/timeSlot/getTimeSlotsByVenuePublic": {
            "get": {
                "tags": [
                    "CampingTimeSlot"
                ],
        ...
        "/camping/timeSlot/updateTimeSlot": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/camping/venueCalendar/getByVenue": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.VenueCalendar"
                                            }
                                        },
                                        "msg": {
                                            "type": "string"
        ...
        "/camping/venueCalendar/set": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "venueId, date(2006-01-02), status",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.VenueCalendarSet"
                        }
                    }
                ],
                "responses": {
        ...
        "/camping/venueOpenTime/getByVenue": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.VenueOpenTime"
                                            }
                                        },
                                        "msg": {
                                            "type": "string"
        ...
        "/camping/venueOpenTime/save": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "body: { venueId, list: [{ weekDay, openTime, closeTime }] }",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/limitedActivity/banner/createBanner": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/limitedActivity/banner/deleteBanner": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/limitedActivity/banner/deleteBannerByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/limitedActivity/banner/findBanner": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/limitedActivity/banner/getBannerList": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/limitedActivity/banner/updateBanner": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/limitedActivity/mini/banner/list": {
            "get": {
        ...
        "/mini/feedback": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "data.list 为反馈列表项（含 ID、content、CreatedAt 等）",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "小程序登录后返回的 token（必填，与 wx 请求头一致）",
                        "name": "x-token",
                        "in": "header"
                    },
                    {
        ...
        "/mini/pay/create": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "data 含 timeStamp,nonceStr,package,signType,paySign",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/response.Response"
        ...
        "/ticket/mini/order/create": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "订单信息（bookerName、bookerPhone、skuId、quantity、visitDate）",
                        "name": "data",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "request.CreateVenueReservationRequest": {
            "type": "object",
            "required": [
                "contactCount",
                "contactName",
        ...
        "request.UpdateVenueReservationRequest": {
            "type": "object",
            "required": [
                "contactCount",
                "contactName",
