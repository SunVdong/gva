...
| [Ticket Gift & Proportional Refund](./ticket-gift-proportional-refund.md) | 赠送次数、次数×数量、按付费次数 A 比例退、sold 回退 | Filled |
| [Ticket Multi-Venue Verify](./ticket-multi-venue-verify.md) | 多次票多场合快照、公开核销 venue、列表筛选、按月场合统计 | Filled |
