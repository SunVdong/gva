...
type Miniprogram struct {
	...
	RefundNotifyURL    string `mapstructure:"refund-notify-url" json:"refund-notify-url" yaml:"refund-notify-url"`           // 退款结果回调，如 https://yourdomain.com/api/mini/pay/refund/notify（留空则由 notify-url 自动推导）
