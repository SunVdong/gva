...
func Api(ctx context.Context) {
	entities := []model.SysApi{
		...
		{Path: "/camping/venueOpenTime/getByVenue", Description: "场地开放时间", ApiGroup: "露营", Method: "GET"},
		{Path: "/camping/venueOpenTime/save", Description: "保存场地开放时间", ApiGroup: "露营", Method: "POST"},
		{Path: "/camping/venueCalendar/getByVenue", Description: "场地日历", ApiGroup: "露营", Method: "GET"},
		{Path: "/camping/venueCalendar/set", Description: "设置场地日历", ApiGroup: "露营", Method: "POST"},
